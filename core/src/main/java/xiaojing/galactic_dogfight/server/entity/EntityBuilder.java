...
import static xiaojing.galactic_dogfight.server.NewId.ENTITY;
...
public class EntityBuilder {
    protected final String entityIdName;
    ...
    protected float speedMoving = 1f;
    ...
    public EntityBuilder(String entityIdName) {
        this.entityIdName = NewId.newIdName(ENTITY, entityIdName);
    }
     ...
     * 设置实体移动速度
     */
    public EntityBuilder speedMoving(float speedMoving) {
