...
import static xiaojing.galactic_dogfight.server.NewId.DISEASE;
import static xiaojing.galactic_dogfight.server.NewId.newIdName;
...
public abstract class DiseaseTemplate {
    ...
    public DiseaseTemplate(String diseaseName, Image image) {
        this.name = newIdName(DISEASE, diseaseName);
        this.image = image;
    }
